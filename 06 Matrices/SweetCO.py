...
imprimirMat(mat)
reversedList=[lstPrecios.reverse()]
print(lstPrecios)
dia,Ganancia=diaMayIng(mat,lstPrecios)
print("El día de la semana con mayor ingresos por ventas es:",dia,f"- Vendió: ${Ganancia:,}")